...
public interface PaperExamReportMapper {
    ...
    @Insert({
        ...
        "paper_id, error, ",
        "right, score, submit_time, ",
        "create_time, content)",
        "values (#{reportId,jdbcType=INTEGER}, #{userId,jdbcType=INTEGER}, ",
        "#{paperId,jdbcType=INTEGER}, #{error,jdbcType=INTEGER}, ",
        "#{right,jdbcType=INTEGER}, #{score,jdbcType=DOUBLE}, #{submitTime,jdbcType=TIMESTAMP}, ",
    ...
    @Select({
        "select",
        "report_id, user_id, paper_id, error, right, score, submit_time, create_time, ",
        "content",
    ...
    @Results({
        ...
        @Result(column="error", property="error", jdbcType=JdbcType.INTEGER),
